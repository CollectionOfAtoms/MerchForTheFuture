...
import { syncDesignedSizesAction } from "@/app/actions/admin/product-catalog";

/**
 * Admin one-click: sync all designed (Prodigi) product-type sizes from the live
 * Prodigi catalog. Enumerates our own designed blanks server-side (no SKU list).
 */
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        onClick={() =>
          start(async () => {
            const r = await syncDesignedSizesAction();
